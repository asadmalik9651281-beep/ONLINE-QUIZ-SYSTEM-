...
Welcome to the Online Quiz System! This is a desktop application developed using Python's **Tkinter** library. It features a fully customized GUI with multiple windows, interactive quiz modes, and real-time result calculation.
...
<img width="960" height="528" alt="LOGIN image" src="https://github.com/user-attachments/assets/81252c58-baa2-4f48-bf88-a87bd7a1ec58" />
...
<img width="960" height="522" alt="QUIZ online SYSTEM" src="https://github.com/user-attachments/assets/58a7e5d0-fb1e-43aa-bcdc-ea4d0285fad3" />
...
* **📚 Options:** Users can choose between two distinct modes:
    * **MCQs QUIZ** (Multiple Choice Questions)
    * **WRITTEN QUIZ** (Subjective/Theory Questions)
* **🔘 Selection:** Large, interactive buttons like **"Attempt MCQs"** make the selection process seamless.
  
<img width="960" height="523" alt="Select a quiz" src="https://github.com/user-attachments/assets/b7a12274-a5bf-40b9-bc49-4b25c7d477eb" />
...
* **⚙️ Logic:** The student selects an answer and clicks **"Next"**. The system tracks the score accurately in the background.
  ...
  <img width="817" height="312" alt="MCQS 1" src="https://github.com/user-attachments/assets/52494569-9aa8-4d80-9d16-89a977e1eb1c" />
  <img width="781" height="353" alt="MCQS2" src="https://github.com/user-attachments/assets/343e5732-64e1-4047-90ba-6bb30a597039" />
...
* **📊 Output:** An informative **Result Popup** appears, displaying the final score (e.g., `MCQs Score: 4 / 5`). ✅
  <img width="351" height="174" alt="MCQS RESULT" src="https://github.com/user-attachments/assets/9a089830-df93-4907-a2ae-61ae63c8947b" />
...
<img width="960" height="454" alt="Written QUIZ" src="https://github.com/user-attachments/assets/d1385aff-ac32-49c0-946b-8dd0e2065d29" />

---

### 7. 📈 Written Marks Calculation
Once submitted, the system validates the response entries.
<img width="293" height="152" alt="written quiz result" src="https://github.com/user-attachments/assets/68ea623f-fb8d-4aaf-befa-121d679ffa45" />
